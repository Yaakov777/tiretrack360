...
<body>
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#nuevaAlertaModal">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <h3 class="mb-0">
                                            <?= round($estadisticas['tiempo_resolucion_promedio'] ?? 0, 1) ?></h3>
                                        ...
                                        <ul class="nav nav-pills">
                                            <li class="nav-item">
                                                <a class="nav-link <?= empty($_GET['estado']) ? 'active' : '' ?>"
                                                    href="alertas.php">
                                                    Activas
                                                    (<?= $estadisticas['pendientes'] + $estadisticas['revisadas'] ?>)
                                                </a>
                                            </li>
                                            <li class="nav-item">
                            ...
                            <form method="GET" class="row g-3">
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" name="tipo">
                                        ...
                                        <option value="rotacion_30"
                                            <?= ($_GET['tipo'] ?? '') == 'rotacion_30' ? 'selected' : '' ?>>
                                            Rotación 30%
                                        </option>
                                        <option value="desgaste_limite"
                                            <?= ($_GET['tipo'] ?? '') == 'desgaste_limite' ? 'selected' : '' ?>>
                                            Desgaste Límite
                                        </option>
                                        <option value="mantenimiento"
                                            <?= ($_GET['tipo'] ?? '') == 'mantenimiento' ? 'selected' : '' ?>>
                                            Mantenimiento
                                        </option>
                                    </select>
                                </div>
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="btn-group btn-group-sm">
                            ...
                            <button type="button" class="btn btn-outline-success"
                                onclick="accionesMultiples('revisada')">
                                <i class="bi bi-eye"></i> Marcar Revisadas
                            </button>
                            <button type="button" class="btn btn-outline-warning"
                                onclick="accionesMultiples('resuelta')">
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr class="alerta-row alerta-<?= $alerta['prioridad'] ?> <?= $alerta['es_urgente'] ? 'urgente' : '' ?>"
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-<?= getPrioridadColor($alerta['prioridad']) ?> position-relative">
                                                ...
                                                <i class="bi bi-exclamation-triangle-fill position-absolute top-0 start-100 translate-middle text-danger"
                                                    ...
                                                    title="Urgente - Más de 7 días pendiente"></i>
                                                <?php endif; ?>
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div>
                                                <strong><?= $alerta['equipo_codigo'] ?></strong> - Pos.
                                                <?= $alerta['posicion'] ?><br>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-switch mb-3">
                                    ...
                                    <label class="form-check-label" for="rotacion_30_activa">
                                        ...
                                        <small class="text-muted">Alerta cuando el neumático alcanza 30% de
                                            desgaste</small>
                                    </label>
                                </div>
        ...
        if (confirm('¿Ejecutar verificación automática de alertas?')) {
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        alert(
                            `Verificación completada. ${response.alertas_generadas} nuevas alertas generadas.`
                            );
                        location.reload();
                    } else {
    ...
    $('#nuevaAlertaForm').on('submit', function(e) {
        ...
        // Show loading state
        $(this).find('button[type="submit"]').html('<i class="bi bi-hourglass-split"></i> Creando...').prop(
            'disabled', true);
    });
