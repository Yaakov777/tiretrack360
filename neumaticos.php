        ...
        <div class="row">
            ...
            <nav class="col-md-2 d-md-block sidebar p-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="neumaticos.php">
            ...
            <main class="col-md-10 ms-sm-auto main-content p-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#neumaticModal">
                        ...
                        <form method="GET" class="row g-3">
                            ...
                            <div class="col-md-2">
                                <select class="form-select" name="estado">
                                    ...
                                    <option value="inventario" <?= ($_GET['estado'] ?? '') == 'inventario' ? 'selected' : '' ?>>
                                        Inventario
                                    </option>
                                    <option value="instalado" <?= ($_GET['estado'] ?? '') == 'instalado' ? 'selected' : '' ?>>
                                        Instalado
                                    </option>
                                    <option value="desechado" <?= ($_GET['estado'] ?? '') == 'desechado' ? 'selected' : '' ?>>
                                        Desechado
                                    </option>
                                </select>
                            </div>
                                    ...
                                    <?php else: ?>
                                        <?php foreach ($neumaticos as $neumatico): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge estado-badge bg-<?= getEstadoColor($neumatico['estado']) ?>">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="diseno_id" name="diseno_id" required>
                                    ...
                                    <?php foreach ($disenos as $diseno): ?>
                                        <option value="<?= $diseno['id'] ?>"><?= $diseno['nombre'] ?> (<?= $diseno['tipo'] ?>)</option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <input type="number" class="form-control" id="costo_nuevo" name="costo_nuevo"
